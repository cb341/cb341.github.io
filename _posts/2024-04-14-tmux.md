---
title: "Supercharge Your Tmux Setup"
...
tags: ["tmux", "terminal"]
preload_image: "/assets/blog/tmux-no-autoresize-poster.webp"
---
...
<video class="article-video" autoplay muted loop playsinline preload="auto" poster="/assets/blog/tmux-no-autoresize-poster.webp" width="760" height="586" aria-label="Managing window panes in tmux with auto-resizing not configured.">
  <source src="/assets/blog/tmux-no-autoresize.webm" type="video/webm">
</video>
_Panes without auto-resize, manually spreading with `<PREFIX> + E`_
...
<video class="article-video" data-lazy-autoplay muted loop playsinline preload="none" poster="/assets/blog/tmux-with-autoresize-poster.webp" width="800" height="617" aria-label="Creating window panes in tmux with auto-resizing configured.">
  <source data-src="/assets/blog/tmux-with-autoresize.webm" type="video/webm">
</video>
_Panes automatically spreading after adding the `select-layout -E` hooks_
...
<video class="article-video" data-lazy-autoplay muted loop playsinline preload="none" poster="/assets/blog/tmux-dimming-panes-poster.webp" width="900" height="695" aria-label="Switching panes in tmux with dimming enabled.">
  <source data-src="/assets/blog/tmux-dimming-panes.webm" type="video/webm">
</video>
_Inactive panes dimmed using focus hooks_
