...
i study computer science (BSC) at [ZHAW](https://www.zhaw.ch/) school of engineering, currently in my third year, there i am also TA for the theory of computation.

this semester i am also studying proof based abstract linear algebra through the [Akademiestudium at FernUniversität in Hagen](https://www.fernuni-hagen.de/mi/studium/akademiestudium.shtml).

outside my degree, most of my time goes into mathematics, logic, and philosophy.

**currently**: proofs, abstract linear algebra, lean, mathematical foundations, metaphysics, papers, books, and whatever rabbit hole takes over next.

i still enjoy building CRUD-y web apps at [Renuo](https://renuo.ch). i just spend much less of my free time building software than i used to.

i like people who say what they mean, show their sources, and ask the actual question. [calling bullshit](https://callingbullshit.org/) and [no hello](https://nohello.net/en/) get the idea.

somewhere along the way, all of this turned into wanting a phd. still figuring out what in.
...
RoR. terminals. plain text. tools that do one thing well.
ASM is probably my favourite language for its stupidity. Ruby for readability. Rust for making assumptions into rules.
...
why CSS?! why can't we just use TXT.
...
interfaces and how people use them, browsers, renderers, languages, runtimes, operating systems, kernels, architecture, instructions, computation, logic gates, electricity, quantum mechanics.
